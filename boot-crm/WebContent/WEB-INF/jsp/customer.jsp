		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="get" 
					...
					<div class="form-group">
						<label for="customerFrom">宽带地址</label> 
					...
					<div class="form-group">
						<label for="custIndustry">所属专业</label> 
							...
							<c:forEach items="${page.rows}" var="row">
								<tr>
									...
									<td>
										...
										<a href="#" class="btn btn-danger btn-xs" onclick="deleteCustomer(${row.cust_id})">禁用</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="new_customer_form">
					...
					<div class="form-group">
						<label for="new_customerFrom" style="float:left;padding:7px 15px 0 27px;">宽带地址</label> 
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label for="new_custIndustry" style="float:left;padding:7px 15px 0 27px;">所属专业</label>
						<div class="col-sm-10"> 
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="edit_customer_form">
					...
					<div class="form-group">
						<label for="edit_customerFrom" style="float:left;padding:7px 15px 0 27px;">宽带地址</label> 
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label for="edit_custIndustry" style="float:left;padding:7px 15px 0 27px;">所属专业</label>
						<div class="col-sm-10"> 
